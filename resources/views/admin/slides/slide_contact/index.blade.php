...
@section('title','- Admin slide contact')
@section('sectionTitle', 'Slides contact-us page')
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header card-header-info card-header-icon">
                        ...
                        <h4 class="card-title">All Slides contact-us page</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="toolbar">
                            ...
                            <div class="submit text-center">
                                <a href="{{route('add_slide_contact')}}" class="btn btn-rose btn-raised btn-round">
                        ...
                        <div class="material-datatables">
                            <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                ...
                                <tbody>
                                @foreach($slidescontacts as $lk)
                                <tr id="tr_{{$lk->id}}">


                                    <td><img src="{{ URL::to('assets/img/slides/'.$lk->slide_contact) }}" style="height: 50px; width: 80px" ></td>
                                    ...
                                    <td class="td-actions text-right">
                                        ...
                                        @can('edit-slide')
                                        <a href="{{ URL::to('/admin/edit-slide-contact/'.$lk->id) }}" class="btn btn-link  btn-success btn-round btn-just-icon " title="Edit your Slide">
...
<div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="deleteLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ URL::to('/admin/delete-slide-contact/'.'slug') }}" method="post">
                {{ csrf_field() }}
                <div class="modal-body">
                    <b>Are you sure you want to delete this slide contact-us page ?</b>
                    <input type="hidden" name="slidescontact_id" id="cat_id" value="">
                </div>
