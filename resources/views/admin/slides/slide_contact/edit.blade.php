            ...
            <div class="col-md-10 col-sm-6 ml-auto mr-auto">
                <div class="card">
                    ...
                    <div class="card-body">
                        <br>
                        @include('inc.alert')
                        <form id="RegisterValidation"  role="form" method="POST" action="{{ route('update_slide_contact',$slidescontact->id) }}" enctype="multipart/form-data" accept-charset="UTF-8">
                            {{ csrf_field() }}


                            @include('admin.slides.slide_contact.form')
                            <div class="submit">
