...
@section('sectionTitle', 'Create Slide Testimonial page')
            ...
            <div class="col-md-10 col-sm-6 ml-auto mr-auto">
                <div class="card">
                    ...
                    <div class="card-body">
                        <br>
                        @include('inc.alert')
                        <form id="RegisterValidation"  role="form" method="POST" action="{{route('save_slide_testimonial')}}" enctype="multipart/form-data" accept-charset="UTF-8">
                            {{ csrf_field() }}


                                @include('admin.slides.slide_testimonial.form',['slidestestimonial' => new \App\Model\user\partial\slides\slidestestimonial()])
                                <div class="submit">
