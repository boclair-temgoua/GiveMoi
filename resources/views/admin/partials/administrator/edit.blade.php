                    ...
                    <form id="RegisterValidation" role="form" method="POST" action="{{ route('administrators.update',$admin->id) }}" accept-charset="UTF-8">
                        ...
                        <div class="card-body">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="input-group form-control-lg">
                                                ...
                                                <div class="form-group{{ $errors->has('username') ? ' has-error' : '' }}">
                                                    ...
                                                    <input type="text" class="form-control" id="exampleInput1" name="username" value="{{ $admin->username }}" required>
                            ...
                            <div class="submit text-center">
                                <input type="submit" class="btn btn-rose btn-raised btn-round"  value="Update Admin">
                            </div>
                        </div>
                        <div class="submit text-center">
